...
static void init_proc_e500 (CPUPPCState *env, int version)
{
    ...
    switch (version) {
        ...
        case fsl_e5500:
            ...
            break;
        case fsl_e6500: /* FIXME: To be checked, Altivec (IVOR32 enabled) */
    ...
    spr_register(env, SPR_BOOKE_EPCR, "BOOKE_EPCR",
                 ...
                 0x00000000);
    /* XXX : not implemented*/
    spr_register(env, SPR_BOOKE_SPRG8, "BOOKE_SPRG8",
                 SPR_NOACCESS, SPR_NOACCESS,
                 &spr_read_generic, &spr_write_generic,
                 0x00000000);
    /* XXX : not implemented*/
    ...
    /* XXX : not implemented*/
    spr_register(env, SPR_BOOKE_SPRG9, "SPR_BOOKE_SPRG9",
                 SPR_NOACCESS, SPR_NOACCESS,
                 &spr_read_generic, &spr_write_generic,
                 0x00000000);
    ...
    if ((version == fsl_e5500) || (version == fsl_e6500) /* FIXME: to be checked */) {
