...
static void fsl_e500_init(fsl_e500_config *config, QEMUMachineInitArgs *args)
{
    ...
    ram = g_malloc0(sizeof(*ram));
    memory_region_init_ram(ram, NULL, "p2010.ram_L2", 0x1000000 /* 512 * 1024 */);
...
static void p2010rdb_vxworks_init(QEMUMachineInitArgs *args)
{
    fsl_e500_init(&p2010rdb_vxworks_config, args);
}
...
static void p2010rdb_init(QEMUMachineInitArgs *args)
{
    fsl_e500_init(&p2010rdb_config, args);
}
...
static void wrsbc8548_vxworks_init(QEMUMachineInitArgs *args)
{
    fsl_e500_init(&wrsbc8548_vxworks_config, args);
}
...
static void wrsbc8548_vx653_init(QEMUMachineInitArgs *args)
{
    fsl_e500_init(&wrsbc8548_vx653_config, args);
}
...
static void wrsbc8548_init(QEMUMachineInitArgs *args)
{
    fsl_e500_init(&wrsbc8548_config, args);
}
