...
static void xlnx_crl_reset_hold(Object *obj, ResetType type)
{
    xlnx_crl_lpd_lsbus_update(obj, ClockUpdate);
}

static void xlnx_crl_reset_exit(Object *obj, ResetType type)
{
    xlnx_crl_lpd_lsbus_update(obj, ClockUpdate);
}

static void xlnx_crl_class_init(ObjectClass *klass, const void *data)
{
