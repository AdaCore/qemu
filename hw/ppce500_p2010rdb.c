...
#define P2010RDB_SERIAL0_REGS_BASE  (0x28700000) //(P2010RDB_CCSRBAR_BASE + 0x04500)
#define P2010RDB_SERIAL1_REGS_BASE  (0x28800000) //(P2010RDB_CCSRBAR_BASE + 0x04600)
...
static fsl_e500_config wrSbc8560_vx653_config = {
...
static void wrSbc8560_vx653_init(ram_addr_t ram_size,
                                 const char *boot_device,
                                 const char *kernel_filename,
                                 const char *kernel_cmdline,
                                 const char *initrd_filename,
                                 const char *cpu_model)
{
    fsl_e500_init(&wrSbc8560_vx653_config, ram_size, boot_device,
                  kernel_filename, kernel_cmdline, initrd_filename, cpu_model);
}

static QEMUMachine wrSbc8560_vx653_machine = {
    .name = "wrSbc8560_vx653",
    .desc = "wrSbc8560 initialized for VxWorks 653",
    .init = wrSbc8560_vx653_init,
};
...
static void p2010rdb_machine_init(void)
{
    ...
    qemu_register_machine(&wrSbc8560_vx653_machine);
}
