...
{
    CharDriverState *serial = semihosting_hds[0];

    if (serial == NULL) {
        return 0;
    }

    if (qemu_chr_fe_claim(serial) == 0) {
        qemu_chr_add_handlers(serial,
